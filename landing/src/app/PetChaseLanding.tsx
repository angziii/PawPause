...
const downloadOptions = [
  {
    ...
    href: `${repoUrl}/releases/download/${latestVersion}/PawPause-1.0.8-mac-arm64.dmg`,
  },
  {
    title: "macOS Intel",
    meta: "Intel Mac · DMG",
    href: `${repoUrl}/releases/download/${latestVersion}/PawPause-1.0.8-mac-x64.dmg`,
  },
  {
    title: "Windows",
    meta: "64-bit · EXE",
    href: `${repoUrl}/releases/download/${latestVersion}/PawPause-1.0.8-win-x64.exe`,
  },
  {
    title: "More builds",
...
const copies: Record<Language, LandingCopy> = {
  "zh-CN": {
    ...
    bubbles: "v1.0.8 新增 Windows 应用内更新，修复 WSL 里的 Hermes 提示，并让更新后导入桌宠更稳。",
    release: "Latest release: v1.0.8",
    downloadTitle: "选择安装包",
  ...
  en: {
    ...
    bubbles: "v1.0.8 adds Windows in-app updates, fixes Hermes prompts from WSL, and keeps imported companions stable across updates.",
    release: "Latest release: v1.0.8",
  ...
  ja: {
    ...
    bubbles: "v1.0.8 ではアプリ内更新、WSL 上の Hermes 通知修正、更新後の相棒データ保護を追加しました。",
    release: "Latest release: v1.0.8",
  ...
  ko: {
    ...
    bubbles: "v1.0.8은 앱 내 업데이트, WSL Hermes 알림 수정, 업데이트 후 가져온 펫 보호를 추가합니다.",
    release: "Latest release: v1.0.8",
  ...
  es: {
    ...
    bubbles: "v1.0.8 agrega actualizaciones dentro de la app, corrige Hermes en WSL y protege mascotas importadas.",
    release: "Latest release: v1.0.8",
  ...
  fr: {
    ...
    bubbles: "v1.0.8 ajoute les mises à jour intégrées, corrige Hermes dans WSL et protège les compagnons importés.",
    release: "Latest release: v1.0.8",
  ...
  de: {
    ...
    bubbles: "v1.0.8 bringt In-App-Updates, behebt Hermes-Hinweise aus WSL und schützt importierte Begleiter.",
    release: "Latest release: v1.0.8",
  ...
  ru: {
    ...
    bubbles: "v1.0.8 добавляет обновления в приложении, исправляет Hermes в WSL и защищает импортированных питомцев.",
    release: "Latest release: v1.0.8",
  ...
  ar: {
    ...
    bubbles: "يضيف v1.0.8 التحديث من داخل التطبيق، ويصلح Hermes داخل WSL، ويحمي الشخصيات المستوردة.",
    release: "Latest release: v1.0.8",

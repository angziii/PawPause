...
const copies: Record<Language, LandingCopy> = {
  "zh-CN": {
    ...
    hero: "让电子宠物住进桌面：提醒休息、喝水、保持专注，也能在 Codex / Claude Code / OpenCode / DeepSeek TUI 工作时给你动态提示。",
  ...
  ja: {
    ...
    eyebrow: "Interactive desktop companion",
    hero: "休憩・水分補給・集中を支え、Codex / Claude Code / OpenCode / DeepSeek TUI の作業状況も知らせるピクセル相棒です。",
  ...
  ko: {
    ...
    eyebrow: "Interactive desktop companion",
    hero: "휴식, 물 마시기, 집중을 돕고 Codex / Claude Code / OpenCode / DeepSeek TUI 작업 상태도 알려주는 픽셀 동반자입니다.",
  ...
  es: {
    ...
    eyebrow: "Interactive desktop companion",
    hero: "Una mascota pixel para pausas, agua, concentración y avisos en vivo de Codex / Claude Code / OpenCode / DeepSeek TUI.",
  ...
  fr: {
    ...
    eyebrow: "Interactive desktop companion",
    hero: "Un compagnon pixel pour les pauses, l'eau, la concentration et les alertes Codex / Claude Code / OpenCode / DeepSeek TUI.",
  ...
  de: {
    ...
    nav: { download: "Download", github: "GitHub", petdex: "PetDex" },
    eyebrow: "Interactive desktop companion",
    hero: "Ein Pixel-Begleiter für Pausen, Wasser, Fokus und Live-Hinweise von Codex / Claude Code / OpenCode / DeepSeek TUI.",
  ...
  ru: {
    ...
    eyebrow: "Interactive desktop companion",
    hero: "Пиксельный помощник для пауз, воды, фокуса и статусов Codex / Claude Code / OpenCode / DeepSeek TUI.",
  ...
  ar: {
    ...
    eyebrow: "Interactive desktop companion",
    hero: "رفيق بكسل للتوقفات وشرب الماء والتركيز وتنبيهات Codex / Claude Code / OpenCode / DeepSeek TUI الحية.",
